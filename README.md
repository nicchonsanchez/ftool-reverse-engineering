...
| [`docs/binary-analysis.md`](docs/binary-analysis.md) | Análise do binário `Ftool.exe` — format strings, error messages, field labels confirmados |
| [`profile-catalog.json`](profile-catalog.json) | Catálogo completo extraído do `.exe` — 1836 perfis comerciais (Vallourec, Welded I, Gerdau, etc.) com propriedades A, I, etc. |
| [`profile-catalog.README.md`](profile-catalog.README.md) | Documentação do catálogo de perfis extraído |
...
| [`docs/binary-analysis.md`](docs/binary-analysis.md) | `Ftool.exe` binary analysis — confirmed format strings, error messages, field labels (mostly PT, EN summary at top) |
| [`profile-catalog.json`](profile-catalog.json) | Full catalog extracted from `.exe` — 1836 commercial profiles (Vallourec, Welded I, Gerdau, etc.) with A, I, etc. |
| [`profile-catalog.README.md`](profile-catalog.README.md) | Profile catalog documentation |
